...
class College(models.Model):
    college_id = models.CharField(max_length=20,primary_key = True, default="ADC-KKD",blank=True, null=False)
...
class Team(models.Model):
    team_id = models.CharField(max_length=20,primary_key = True, unique=False)
    team_name = models.CharField(max_length=50)
    college_id = models.ForeignKey(College, on_delete=models.CASCADE,blank=True,null=True)
...
class Student(models.Model):
    stud_id = models.CharField(max_length=220,primary_key=True)
    s_password = models.CharField(max_length=30)
    in_out = models.CharField(max_length=5)
    f_name = models.CharField(max_length=220)
    l_name = models.CharField(max_length=220)
...
class Faculty(models.Model):
    ...
    l_name = models.CharField(max_length=2250)
    team_id = models.ForeignKey(Team, on_delete=models.CASCADE)
    college_id = models.ForeignKey(College, on_delete=models.CASCADE)
...
class Teache(models.Model):
    fac_id = models.ForeignKey(Faculty, on_delete=models.CASCADE,unique=False)
    course_id = models.ForeignKey(Course, on_delete=models.CASCADE, null=True,unique=False)
    class_id = models.ForeignKey(Class, on_delete=models.CASCADE,unique=False)
